...
hash_t hashit_create(uint32_t sizehint, size_t keysize, 
	             uint32_t (*hfunc)(unsigned char *, unsigned long),
...
int hashit_delete(hash_t htable, void *key) 
{
    ASSERT(htable);
    ASSERT(key); 
...
int hashit_replace(hash_t htable, void *key, void *newdata)
{
    ASSERT(htable);
    ASSERT(key);
    ASSERT(newdata);
...
static int ch_insert(hash_t htable, void *key, void *data) 
{
    uint32_t idx;
    struct elem* cursor;
    struct elem* oneelem;
...
static void *ch_lookup(hash_t htable, void *key) 
{
    uint32_t idx;
    struct elem *cursor;
...
static int ch_delete(hash_t htable, void *key) 
{
    uint32_t idx;
...
/* TODO: Implement callbacks so ch_delete can free this data */
static int ch_replace(hash_t htable, void *key, void *newdata)
{
    uint32_t idx;
    struct elem *cursor;
...
static int ch_destroy(hash_t htable) 
{
    uint32_t idx;
    struct elem *cursor;
...
static void **ch_getkeys(hash_t htable)
{
    uint32_t idx;
    struct elem *cursor;
    void **keys;
...
static int oa_insert(hash_t htable, void *key, void *data)
{
    uint32_t pos;
    uint32_t idx;
...
static int oa_delete(hash_t htable, void *key)
{
    uint32_t pos;
    uint32_t idx;
...
static void *oa_lookup(hash_t htable, void *key)
{
    uint32_t pos;
    uint32_t idx;
...
static int oa_replace(hash_t htable, void *key, void *newdata)
{
    uint32_t pos;
    uint32_t idx;
...
static int oa_destroy(hash_t htable)
{
...
/* Return a NULL terminated string of pointers to all hash table keys */
static void **oa_getkeys(hash_t htable)
{
    uint32_t	idx;
    void	**keys;
    uint32_t	kidx; 
...
static int ov_insert(hash_t htable, void *key, void *data)
{
    uint32_t idx;
    uint32_t tidx;
    struct elem *cursor;
...
static int ov_delete(hash_t htable, void *key)
{
    uint32_t idx;
    struct elem *cursor;
...
static void *ov_lookup(hash_t htable, void *key)
{
    uint32_t idx;
    struct elem *cursor;
...
static int ov_replace(hash_t htable, void *key, void *newdata)
{
    uint32_t idx;
    struct elem *cursor;
...
static int ov_destroy(hash_t htable)
{
    free(htable->cm.ov->ovtable);
...
/* Return a NULL terminated string of pointers to all hash table keys */
static void **ov_getkeys(hash_t htable)
{
    uint32_t idx;
    uint32_t kidx; 
    struct elem *cursor;
...
/* Accesors ******************************************************************/
inline size_t hashit_tablesize(hash_t htable)
{
    return htable->tsize;
}


inline size_t hashit_size(hash_t htable)
{
...
/* Misc functions ************************************************************/
static uint32_t gethash(hash_t htable, void *key) 
{
    size_t len;
